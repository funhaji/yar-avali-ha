    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
          <ClientSubscriptionHeaderLink />
          <Link href="/dashboard" className="px-4 py-2 text-teal-600 hover:bg-teal-50 rounded-lg">
            داشبورد
          </Link>
        </nav>
      </header>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
              <div className="text-center mb-4">
                <span className="text-sm text-teal-600 font-medium">مدت اشتراک</span>
                <div className="text-3xl font-bold text-teal-600 mt-1">۶ ماه</div>
              </div>
            ...
            <form onSubmit={handleRedeem} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-center text-2xl font-mono tracking-wider"
